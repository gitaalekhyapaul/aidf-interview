...
export function QuizResults() {
  ...
  const topicPerformance = state.userAnswers.reduce((acc, answer) => {
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card className="finance-card text-center">
            <CardHeader>
              <div className="flex justify-center mb-4">
                <div
                  className={`w-20 h-20 rounded-full ${performance.bgColor} flex items-center justify-center`}
                >
          ...
          <Card className="finance-card">
            <CardHeader>
              ...
              <CardDescription>
                See how you performed across different CFA topics
              </CardDescription>
            </CardHeader>
            <CardContent>
                    ...
                    <div key={topic} className="space-y-2">
                      <div className="flex justify-between items-center">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Badge
                            variant="outline"
                            className={`${topicPerf.bgColor} ${topicPerf.color} border-current`}
                          >
                            {topicPercentage}%
                          </Badge>
                        </div>
          ...
          <Card className="finance-card">
            ...
            <CardContent>
              <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm text-muted-foreground">
                          You scored{" "}
                          {Math.round((stats.correct / stats.total) * 100)}% in
                          this topic. Consider reviewing the key concepts and
                ...
                {Object.entries(topicPerformance).every(
                  ([, stats]) => stats.correct / stats.total >= 0.7
                ) && (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p>
                      You scored well across all topics. Keep up the great work!
                    </p>
                  </div>
                )}
              </div>
          ...
          <Card className="finance-card">
            <CardHeader>
              ...
              <CardDescription>
                Continue your CFA exam preparation journey
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-2 gap-4">
                ...
                >
                  <div className="text-left">
                    ...
                    <div className="text-sm text-muted-foreground">
                      Retake the quiz to reinforce your learning
                    </div>
                  </div>
                </Button>
                ...
                <Link href="/">
                  <Button
                    variant="outline"
                    className="h-auto p-4 justify-start w-full bg-transparent"
                  >
                    <div className="text-left">
                      <div className="font-semibold mb-1">
                        Explore More Topics
                      ...
                      <div className="text-sm text-muted-foreground">
                        Return to the main page for more resources
                      </div>
                    </div>
                  </Button>
                </Link>
